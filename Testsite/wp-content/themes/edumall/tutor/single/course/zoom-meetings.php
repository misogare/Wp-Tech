							...
							<div class="tutor-zoom-meeting-detail">
								...
								<div>
									<p><?php esc_html_e( 'ID', 'edumall' ); ?>:
										<span><?php echo $meeting_data['id']; ?></span> <i class="tutor-icon-copy"></i>
									</p>
									<p><?php esc_html_e( 'Password', 'edumall' ); ?>:
										<span><?php echo $meeting_data['password']; ?></span> <i
						...
						<div class="tutor-course-lessons tutor-zoom-meeting-session"
							...
							<?php if ( $zoom_meeting->is_expired ) { ?>
								<div class="msg-expired-section">
									<img src="<?php echo TUTOR_ZOOM()->url . 'assets/images/zoom-icon-expired.png'; ?>"
									     alt=""/>
									<div>
								...
								<div class="tutor-zoom-meeting-countdown" data-timer="<?php echo $zoom_meeting->countdown_date; ?>"
								     data-timezone="<?php echo $zoom_meeting->timezone; ?>">
								</div>
								<div class="session-link">
									<p><?php esc_html_e( 'Host Email', 'edumall' ); ?>
										: <?php echo $meeting_data['host_email']; ?></p>
									<a href="<?php echo get_permalink( $meeting->ID ); ?>"
