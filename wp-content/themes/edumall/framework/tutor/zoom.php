...
if ( ! class_exists( 'Edumall_Tutor_Zoom' ) ) {
	class Edumall_Tutor_Zoom {
		...
		public function initialize() {
			...
			add_filter( 'tutor_dashboard/nav_items/settings/nav_items', [ $this, 'add_zoom_settings' ] );
		...
		public function add_zoom_settings( $nav_items ) {
			if ( ! isset( $nav_items['zoom'] ) ) {
				$nav_items['zoom'] = [
					'url'   => tutor_utils()->get_tutor_dashboard_page_permalink( 'settings/zoom-settings' ),
					'title' => __( 'Zoom', 'edumall' ),
					'role'  => 'instructor',
				];
			}
